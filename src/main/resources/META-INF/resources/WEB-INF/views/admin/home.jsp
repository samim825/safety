...
<!-- Mirrored from www.pixelwibes.com/template/ihealth/html/dist/help.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Sep 2022 13:14:28 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=Edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">

    <title>:: I-Health:: Help</title>
    ...
    <div class="sidebar px-4 py-4 py-md-5 me-0">
        <div class="d-flex flex-column h-100">
            ...
            <ul class="menu-list flex-grow-1 mt-3">
                <li class="collapsed">
                    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#dashboard" href="#">
                ...
                <li><a class="m-link active" href="virtual.html"><i class="icofont-ui-video-chat fs-5"></i> <span>I-Health Virtual</span></a></li>
                <li class="collapsed">
                        ...
                        <div class="card border-0">
                            ...
                            <div class="card-body">
                                <div class="mb-4 overflow-hidden">
                                    ...
                                    <div class="p-4">
                                        <p class="fw-bold">I-Health guide</p>
                                        <span>Get started with I-Health Business and learn about features for admins and users.</span>
                                        <div class="mt-4 mb-2">
