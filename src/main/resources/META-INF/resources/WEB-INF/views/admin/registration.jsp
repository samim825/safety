                        ...
                        <div class="w-100 p-3 p-md-5 card border-0 bg-dark text-light" style="max-width: 32rem;">
                            ...
                            <form class="row g-1 p-3 p-md-4" action="/admin/registration" method="post">
                                <div class="col-12 text-center mb-5">
                                    <h1 style="color:black" class="text-center">${msg}</h1>
...
<!-- Mirrored from www.pixelwibes.com/template/ihealth/html/dist/ui-elements/auth-signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Sep 2022 13:14:38 GMT -->
</html>