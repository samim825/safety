...
<%--                </div>--%>
                <div class="dropdown user-profile ml-2 ml-sm-3 d-flex align-items-center zindex-popover">
                    <div class="u-info me-2">
                        <p class="mb-0 text-end line-height-sm "><span class="font-weight-bold">${user.getHospital().getHospitalName()}</span></p>
                            ...
                            <div class="card-body pb-0">
                                <div class="d-flex py-1">
                                    ...
                                    <div class="flex-fill ms-3">
                                        <p class="mb-0"><span class="font-weight-bold">${user.getHospital().getHospitalName()}</span></p>
